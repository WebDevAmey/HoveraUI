export default function ChamberDoorButton() {
  return (
    <button className="group relative inline-block h-14 w-48 cursor-pointer bg-transparent [perspective:1000px] [transform-style:preserve-3d] focus-visible:outline-2 focus-visible:outline-offset-2">
