export default function LuminanceFlux() {
    return (
        <button className="group relative px-14 py-4 rounded-2xl text-white font-semibold bg-slate-900 overflow-hidden shadow-[0_0_30px_rgba(120,0,255,0.3)] transition hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2">
