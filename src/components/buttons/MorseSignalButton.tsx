export default function MorseSignalButton() {
  return (
    <button className="group inline-flex flex-col items-center gap-2 rounded-lg border border-emerald-500/40 bg-neutral-950 px-8 py-4 font-mono text-sm tracking-widest text-emerald-400 focus-visible:outline-2 focus-visible:outline-offset-2">
