export default function RivetPressButton() {
  return (
    <button className="group relative inline-flex h-14 w-44 items-center justify-center rounded-md border-2 border-neutral-700 bg-gradient-to-b from-neutral-800 to-neutral-900 font-bold tracking-wide text-neutral-300 focus-visible:outline-2 focus-visible:outline-offset-2">
