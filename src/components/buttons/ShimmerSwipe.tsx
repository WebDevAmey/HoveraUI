export default function ShimmerSwipe() {
    return (
        <button className="relative px-10 py-4 rounded-xl bg-indigo-600 text-white font-semibold overflow-hidden group shadow-lg hover:shadow-indigo-500/40 transition hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2">
