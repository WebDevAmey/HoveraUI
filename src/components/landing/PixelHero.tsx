...
const BRAND_LOGOS = [
  () => (
    <svg
      className="h-[22px] sm:h-[28px] w-auto select-none opacity-60 hover:opacity-100 transition-opacity duration-500"
  ...
  () => (
    <div className="flex items-center justify-start font-bold text-sm md:text-base gap-2 text-foreground/75 dark:text-foreground/80 opacity-60 hover:opacity-100 transition-opacity duration-500">
      <svg
        viewBox="0 0 14 21"
        role="presentation"
  ...
  () => (
    <svg
      className="h-[14px] sm:h-[18px] fill-foreground/75 dark:fill-foreground/80 select-none opacity-60 hover:opacity-100 transition-opacity duration-500"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 394 79"
    >
      ...
      <path d="M80.907 79.339L17.0151 0H0V79.3059H13.6121V16.9516L63.8067 79.339H80.907Z"></path>
  ...
  () => (
    <svg
      className="h-[24px] sm:h-[32px] select-none opacity-60 hover:opacity-100 transition-opacity duration-500"
      version="1.1"
