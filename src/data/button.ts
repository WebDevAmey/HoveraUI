...
export const buttons: ButtonItem[] = [
  {
    ...
    code:`<button className="relative overflow-hidden rounded-lg bg-neutral-600 px-7 py-3 text-white group focus-visible:outline-2 focus-visible:outline-offset-2">
  ...
  },
  {
    ...
    code: `<button className="px-8 py-3 bg-neutral-600 text-white font-semibold rounded-xl shadow-lg transform transition-all hover:-translate-y-1 hover:shadow-xl active:translate-y-0 active:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2">
  3D Press
</button>`, 
  } ,
  {
...
shadow-[8px_8px_18px_rgba(39,39,39,0.15),-8px_-8px_18px_rgba(255,255,255,0.9)] 
...
transition focus-visible:outline-2 focus-visible:outline-offset-2">
...

  {
    ...
    code: `<button className="relative z-10 inline-block cursor-pointer overflow-hidden rounded-lg border-2 border-neutral-600 bg-transparent px-6 py-3 text-lg font-semibold text-neutral-600 transition-colors duration-300 ease-in-out before:absolute before:left-1/2 before:top-[120%] before:z-[-1] before:h-[300%] before:w-[150%] before:-translate-x-1/2 before:rounded-[40%] before:bg-neutral-400 before:transition-all before:duration-700 before:ease-out before:content-[''] after:absolute after:left-1/2 after:top-[120%] after:z-[-1] after:h-[300%] after:w-[160%] after:-translate-x-1/2 after:rounded-[43%] after:bg-neutral-600 after:transition-all after:duration-500 after:delay-75 after:ease-out after:content-[''] hover:text-white hover:before:top-[-50%] hover:before:rotate-180 hover:after:top-[-50%] hover:after:rotate-[360deg] focus-visible:outline-2 focus-visible:outline-offset-2">
  Liquid Fill
</button>`,
  ...
  },
  {
    ...
    code: `<button className="relative z-10 inline-block cursor-pointer overflow-hidden rounded-lg border-2 border-neutral-600 bg-transparent px-6 py-3 text-lg font-semibold text-neutral-600 transition-colors duration-500 before:absolute before:left-1/2 before:top-1/2 before:z-[-1] before:h-8 before:w-8 before:-translate-x-1/2 before:-translate-y-1/2 before:scale-0 before:rounded-full before:bg-neutral-600 before:transition-transform before:duration-300 before:ease-out before:content-[''] hover:text-white hover:before:scale-[6] focus-visible:outline-2 focus-visible:outline-offset-2">
  Radial Bloom
</button>`,
    needsLightPreview: true,
  },
  ...
  <div className="absolute inset-0 z-0 rounded bg-neutral-400 opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100" />
  ...
  SHREDDER
  <span className="absolute inset-0 flex items-center justify-center bg-neutral-900 text-neutral-500 transition-transform duration-300 ease-out [clip-path:polygon(0_0,_100%_0,_100%_33%,_0_33%,_0_66%,_100%_66%,_100%_100%,_0_100%)] group-hover:translate-y-2">
    SHREDDER
  </span>
  <span className="absolute inset-0 flex items-center justify-center bg-neutral-900 text-neutral-400 transition-transform duration-300 ease-out [clip-path:polygon(0_33%,_100%_33%,_100%_66%,_0_66%,_0_100%,_100%_100%)] group-hover:-translate-y-2">
    SHREDDER
  </span>
</button>`,
  },
  {
    ...
    code: `<button className="group inline-flex flex-col items-center gap-2 rounded-lg border border-neutral-500/40 bg-neutral-950 px-8 py-4 font-mono text-sm tracking-widest text-neutral-400 focus-visible:outline-2 focus-visible:outline-offset-2">
  ...
  },
  {
    ...
    code: `<button className="group relative inline-flex h-16 w-16 items-center justify-center rounded-full bg-neutral-950 text-neutral-400 focus-visible:outline-2 focus-visible:outline-offset-2">
  <span className="absolute inset-0 rounded-full border border-neutral-400/70 opacity-0 scale-50 transition-all delay-0 duration-300 group-hover:scale-100 group-hover:opacity-100" />
  <span className="absolute inset-0 rounded-full border border-neutral-400/50 opacity-0 scale-50 transition-all delay-100 duration-300 group-hover:scale-125 group-hover:opacity-100" />
  <span className="absolute inset-0 rounded-full border border-neutral-400/30 opacity-0 scale-50 transition-all delay-200 duration-300 group-hover:scale-150 group-hover:opacity-100" />
  <span className="absolute inset-0 rounded-full border border-neutral-400/10 opacity-0 scale-50 transition-all delay-300 duration-300 group-hover:scale-[1.75] group-hover:opacity-100" />
  ...
  },
  {
    ...
    code: `<button className="group relative inline-flex h-14 w-40 items-center justify-center overflow-hidden rounded-full bg-neutral-400 font-bold text-black focus-visible:outline-2 focus-visible:outline-offset-2">
  ...
  <span className="relative z-10 transition-colors duration-300 group-hover:text-neutral-300">
    ECLIPSE
  </span>
</button>`,
  },
  ...
  <span className="h-5 w-[2px] origin-bottom scale-y-0 bg-neutral-500 transition-transform delay-0 duration-200 group-hover:scale-y-100" />
  <span className="h-5 w-[2px] origin-bottom scale-y-0 bg-neutral-500 transition-transform delay-100 duration-200 group-hover:scale-y-100" />
  <span className="h-5 w-[2px] origin-bottom scale-y-0 bg-neutral-500 transition-transform delay-200 duration-200 group-hover:scale-y-100" />
  <span className="h-5 w-[2px] origin-bottom rotate-[20deg] scale-y-0 bg-neutral-500 transition-transform delay-300 duration-200 group-hover:scale-y-100" />
</button>`,
  },
  {
  ...
  <span className="absolute h-0 w-0 origin-center border-x-[5px] border-b-[14px] border-x-transparent border-b-neutral-500 transition-transform duration-500 ease-out [transform:rotate(20deg)] group-hover:[transform:rotate(200deg)]" />
  ...
  },
  {
    ...
    code: `<button className="group relative inline-flex h-14 w-44 items-center justify-center overflow-hidden rounded-lg border border-neutral-500/30 bg-neutral-950 font-mono text-sm text-neutral-400 focus-visible:outline-2 focus-visible:outline-offset-2">
  ...
  <span className="absolute inset-0 flex items-center justify-center gap-1 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-0 duration-300 group-hover:h-2" />
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-75 duration-300 group-hover:h-6" />
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-150 duration-300 group-hover:h-3" />
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-200 duration-300 group-hover:h-8" />
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-300 duration-300 group-hover:h-2" />
    <span className="h-2 w-1 bg-neutral-500 transition-all delay-[400ms] duration-300 group-hover:h-5" />
  </span>
</button>`,
  },
  {
