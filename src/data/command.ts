...
export const commands: ComponentItem[] = [
  {
    name: "Command Menu",
    slug: "command-menu",
    category: "command",
    component: CommandMenu as React.ComponentType,
    description: "A cmdk-powered command palette with grouped actions, opened with Cmd/Ctrl+K.",
    dependencies: ["cmdk"],
    code: `"use client";
